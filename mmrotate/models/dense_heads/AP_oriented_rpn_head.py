...
# from ..utils import APConv
# from ..utils import RountingFunctionPro

# device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
# print ("devcie:",device)

# @ROTATED_HEADS.register_module()
# class APconvOrientedRPNHead(RotatedRPNHead):
...
#         self.apconv = APConv(
#                 c1=self.feat_channels,
#                 c2=self.feat_channels,
#                 k1=self.k1,
#                 k2=self.k2,
#                 s=1,
#                 rounting = RountingFunctionPro(in_channels=self.feat_channels,kernel_number=1),
#             )
#         self.arconv = self.apconv.to(device)
