...
class ADRconvLossOrientedRPNHead(RotatedRPNHead):
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        aspect_ratio_weight1 = (2.0 * aspect_ratio_diff + 2.0) / (aspect_ratio_diff + 2.0)
        aspect_ratio_weight2 = 2.0 * target_aspect_ratio / (target_aspect_ratio + 1.0)
        
        aspect_ratio_weight = alpha * aspect_ratio_weight1 + (1.0 - alpha) * aspect_ratio_weight2
